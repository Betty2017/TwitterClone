...
public class PhotoController {
   ...
   long count=0;
    ...
    private LikesRepository likeRepository;
	    ...
	    @PostMapping("/upload")
	    public String singleImageUpload(@RequestParam("file") MultipartFile file, RedirectAttributes redirectAttributes,Principal p, Model model, @ModelAttribute Photo pho){
	        ...
	        try {
	           ...
	           // "<img src='http://res.cloudinary.com/beticloud/image/upload/c_scale,h_100,w_100/"+filename+"'/>"
